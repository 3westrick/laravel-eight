      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav.link route="jobs.index">Jobs</x-nav.link>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <x-nav.link route="register.create">Register</x-nav.link>
            @endguest

            @auth
              <form action="{{ route('login.delete') }}" method="POST">
                @csrf
                <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Log Out</button>
              </form>
            @endauth
